...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        isShowTotalPagination: true,// add new name  2017.11.02 是否显示总条数
        search: false,
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES.en = {
        ...
        // Add new method
        formatshowingSplitMes: function () {
            return sprintf('Showing %s to %s of %s ', pageFrom, pageTo);
        },
        formatRecordsPerPageSplitMes: function (pageNumber) {
            return sprintf('%s rows per page', pageNumber);
        },
    };
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        // Modification method
        if(!this.options.isShowTotalPagination){
            html.push(
                '<div class="pull-' + this.options.paginationDetailHAlign + ' pagination-detail">',
                '<span class="pagination-info">',
                this.options.onlyInfoPagination ? this.options.formatDetailPagination(this.options.totalRows) :
                this.options.formatshowingSplitMes(this.pageFrom, this.pageTo),
                '</span>');
        }else {
            html.push(
                '<div class="pull-' + this.options.paginationDetailHAlign + ' pagination-detail">',
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            // Modification method
            if(!this.options.isShowTotalPagination){
                html.push(this.options.formatRecordsPerPageSplitMes(pageNumber.join('')));
            }else {
