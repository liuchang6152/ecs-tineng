...
var searchUrl = ECS.api.emUrl + '/TeamDeviceConfig';//表格查询
...
var team_url = ECS.api.emUrl + '/DispatchDeviceConfig/getTreeTeam'; //树形结构
var exportUrl = ECS.api.emUrl + '/TeamDeviceConfig/ExportToExcel';  //导出
    ...
    var page = {
        ...
        bindUI: function () {
            ...
            mini.get("tree1").on("nodeselect", function (e){
                $("#searchForm")[0].reset();
                addObj={"baseModelCategory":e.node.obj ,"baseDataId":orgId,"teamId":e.node.id,"enterpriseID": orgId , "deviceMode":"2"};
                flag=true;
                grid.load({ "baseModelCategory":e.node.obj ,"baseDataId":orgId,"teamId":e.node.id,"enterpriseID": orgId , "deviceMode":"2"});
            });
            ...
            $("#btnExport").click(function () {
                ...
                if(addObj){
                    ...
                    page.data.param["teamId"]=addObj.teamId;
                }
        ...
        logic: {
            ...
            initTable: function () {
                ...
                grid.load({"deviceMode":"2","enterpriseID": orgId });//调度模式
            },
            // 设备状态
            ...
            load_sidebar:function(){
                ...
                if(orgCode){
                    $.ajax({
                        url: team_url+"?orgCode="+orgCode+"&treeID="+orgId,
                        type: "GET",
                        beforeSend: function () {
                            ECS.showLoading();
                        },
            ...
            imp: function () {
                var impUrl = ECS.api.emUrl +'/TeamDeviceConfig/importExcel'; 
                var exportUrl =  ECS.api.emUrl +'/TeamDeviceConfig/ExportExcel'; 
                var confirmUrl =  ECS.api.emUrl +'/TeamDeviceConfig/importAddAll'; 
