    ...
    var page = {
        ...
        logic: {
            ...
            moveAdd:function(){
                ...
                if(items.userPhone==null||items.userPhone==""){
                    if(items.userMobile!=null){
                        $("#ownerContact").val(items.userMobile);
                    }else{
                        $("#userContact").val("");
                    }
                }else{
                    $("#ownerContact").val(items.userPhone);
                }
            ...
            setData: function (data) {
                ...
                if(data.userInfo){
                    ...
                    $("#ownerContact").val(data.userInfo.ownerContact);
                }
                $("#grid2 p").click(function() {
                    $(this).siblings('p').removeClass('selected');
                    $(this).addClass('selected');
             ...
             */
            save: function () {
                parent.ownDetail=ECS.form.getData('AddOrEditModal');
